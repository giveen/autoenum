...
| Version | Changes |
|--------|---------|
| **3.0.3** | • General bug fixes and stability improvements across all scan and enumeration modules<br>• Fixed invalid tool flags, unquoted variables, and unsafe shell patterns<br>• Improved compatibility with `set -euo pipefail` strict mode |
